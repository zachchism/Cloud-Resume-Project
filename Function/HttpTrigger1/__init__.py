...
def main(req: func.HttpRequest) -> func.HttpResponse:
    ...
    endpoint = 'https://zachchismcosmodb.documents.azure.com:443/'
    key = 'fRdmVWWxCqlSNJbDxnvfELnRhI9G3olz6VCS3wuokAyPwJhygafHLNWG8ci8EISKoClPmgg6xEdSACDb7ZqAqQ=='
    client = CosmosClient(url=endpoint, credential=key)
    db = client.create_database_if_not_exists(id='Visitors')
